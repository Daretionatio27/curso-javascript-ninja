(function(){
    ...
    */
    function hasClass(markup, cssClass){
        var values = markup.replace(/class="(.+$)"/gm, function (a, val1, val2, val3){return val1 + '.' + val2 + '.' + val3}).split('.')
        switch (cssClass){
            case values[0]:
                return 'true para a classe ' + values[0];
                break;
            case values[1]:
                return 'true para a classe ' + values[1];
                break;
            case values[2]:
                return 'true para a classe ' + values[2];
                break;
            default:
