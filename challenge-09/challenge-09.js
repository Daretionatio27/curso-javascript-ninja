...
(function(){   
        ...
        */
        console.log( 'O resultado da soma é: ' + sum(function(val1, val2){
            return val1 + val2
        }) + '.' );
        ...
        */
        ...
        chamada.
        */
        console.log( 'O resultado da subtração é: ' + subtraction(function(val1, val2){
            return val1 - val2
        }) );
        // -2

        console.log( 'O resultado da multiplicação é: ' + multiplication(function(val1, val2){
            return val1 * val2
        }) );
        // 27

        console.log( 'O resultado da divisão é: ' + division(function(val1, val2){
            return val1 / val2
        }) );
        // 3

        console.log( 'O resto da divisão é: ' + mod(function(val1, val2){
            return val1 % val2
        }) );
        // 2
        }())
